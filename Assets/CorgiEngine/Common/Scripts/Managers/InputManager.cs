...
namespace MoreMountains.CorgiEngine
{
	...
	public class InputManager : MMSingleton<InputManager>
	{
        ...
        ///The Initialize Button, Used to Start The Game!
        ///
        public MMInput.IMButton StartButton { get; protected set; }
		...
		protected virtual void InitializeButtons()
		{
            ...
            ButtonList.Add(StartButton = new MMInput.IMButton(PlayerID, "Start", StartButtonDown));
        ...
        public virtual void StartButtonDown()               { StartButton.State.ChangeState(MMInput.ButtonStates.ButtonDown); }   
